...
def main(selection="user", headless=False, short_exec=False):
    ...
    iteration_count = 0
    output_frequency = 25
    output_file = open("robot_positions.txt", "w")

    while iteration_count < 100:  # Assuming 100 iterations, you can adjust this as needed
        for i in range(100):
            with Profiler("Environment action step"):
                ...
                if iteration_count % output_frequency == 0:
                    output_file.write(f"Iteration {iteration_count}, Robot position: {robot_position}\n")
